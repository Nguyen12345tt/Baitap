...
int main() {
    int arr[] = {4, 3, 1, 5, 7, 9, 6, 2, 10}; 
    int size = sizeof(arr) / sizeof(arr[0]);

    cout << "Mang ban dau: ";
    printArray(arr, size);

    mergeSort(arr, 2, size - 3); //(6) Chỉnh số 0 ở trước size - 3 thành số 2 để bỏ 2 đầu 2 cuối
                                    //(5) Chỉnh size - 2 -> size - 3 để chỉ sắp xếp 6 phần tử đầu 
